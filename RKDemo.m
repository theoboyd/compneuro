...
% simulation using the Runge-Kutta 4 method with a large step size
% and the Euler method for a smaller step size
...
xlabel('t')
ylabel('y')
legend('Exact solution of y = e^t','RK4 method \delta t = 0.5','Euler method \delta t = 0.1',...
   'Location','Best')
